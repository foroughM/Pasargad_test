...
import com.example.kotlin_first.utils.cancelProgressAction
import com.example.kotlin_first.utils.musicDurationExtra
import com.example.kotlin_first.utils.updateProgressAction
...
class UpdateProgressService : Service() {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        duration = intent?.extras?.getLong(musicDurationExtra)
        ...
        if (intent?.action.equals(updateProgressAction)) {
            ...
            countDown?.start()
        } else if (intent?.action.equals(cancelProgressAction)) {
            countDown?.cancel()
            countDown = null
        }
